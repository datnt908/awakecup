...
CREATE TABLE `product` (
    ...
    `ProductTitle` VARCHAR(32) NOT NULL UNIQUE,
...
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00001', 'AMERICANO', 'Americano được pha chế bằng cách thêm nước vào một hoặc hai shot Espresso để pha loãng độ đặc của cà phê, từ đó mang lại hương vị nhẹ nhàng, không gắt mạnh và vẫn thơm nồng nàn.', 1, 39000, 'appdata/products/PRO00001.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00002', 'BẠC SỈU', 'Theo chân những người gốc Hoa đến định cư tại Sài Gòn, Bạc sỉu là cách gọi tắt của "Bạc tẩy sỉu phé" trong tiếng Quảng Đông, chính là: Ly sữa trắng kèm một chút cà phê.',1,29000, 'appdata/products/PRO00002.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00003', 'CAPPUCINNO', 'Cappuccino được gọi vui là thức uống "một-phần-ba" - 1/3 Espresso, 1/3 Sữa nóng, 1/3 Foam.',1,45000, 'appdata/products/PRO00003.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00004', 'LATTE', 'Khi chuẩn bị Latte, cà phê Espresso và sữa nóng được trộn lẫn vào nhau, bên trên vẫn là lớp foam nhưng mỏng và nhẹ hơn Cappucinno.',1,45000, 'appdata/products/PRO00004.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00005', 'MOCHA', 'Cà phê Mocha được ví von đơn giản là Sốt Sô cô la được pha cùng một tách Espresso.',1,49000, 'appdata/products/PRO00005.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00006', 'TRÀ OOLONG VẢI NHƯ Ý', 'Là thức uống "bắt vị" được lấy cảm hứng từ trái Vải - thức quả tròn đầy, quen thuộc trong cuộc sống người Việt - kết hợp cùng Trà Oolong làm từ những lá trà tươi hảo hạng.',2,45000, 'appdata/products/PRO00006.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00007', 'TRÀ ĐÀO CAM SẢ', 'Vị thanh ngọt của đào Hy Lạp, vị chua dịu của Cam Vàng nguyên vỏ, vị chát của trà đen tươi được ủ mới mỗi 4 tiếng, cùng hương thơm nồng đặc trưng của sả chính là điểm sáng làm nên sức hấp dẫn của thức uống này. Sản phẩm hiện có 2 phiên bản Nóng và Lạnh phù hợp cho mọi thời gian trong năm.',2,45000, 'appdata/products/PRO00007.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00008', 'TRÀ PHÚC BỒN TỬ', 'Một sự kết hợp đầy hoàn hảo giữa thanh mát và bổ dưỡng.Lần đầu tiên Trà Oolong và trái "Phúc Bồn Tử" hoàn toàn tự nhiên, được các barista của chúng tôi kết hợp một cách tinh tế để tạo ra một dư vị hoàn toàn tươi mới.Nhấp ngay một ngụm là thấy mát lạnh ngay tức khắc, đọng lại mãi nơi cuốn họng là hương vị trà thơm lừng và vị ngọt thanh, chua dịu khó quên của trái phúc bồn tử.',2,49000, 'appdata/products/PRO00008.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00009', 'TRÀ THƠM 1 CÁI', 'Sự kết hợp sáng tạo của trà thơm (dứa) ngọt dịu, với topping đào dầm vừa quen vừa lạ - cho hương vị giải nhiệt và cực kì vui miệng, giúp cuộc hẹn hò của bạn thêm mát, thêm rôm rả hơn.',2,49000, 'appdata/products/PRO00009.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00010', 'TRÀ MATCHA MACCHIATO', 'Bột trà xanh Matcha thơm lừng hảo hạng cùng lớp Macchiato béo ngậy là một sự kết hợp tuyệt vời. Nếu bạn yêu thích Matcha Latte, không lý nào lại không thử Matcha Macchiato của chúng tôi.',3,45000, 'appdata/products/PRO00010.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00011', 'TRÀ CHERRY MACCHIATO', 'Khoác lên mình một ngoại hình tràn đầy năng lượng với sắc đỏ rực rỡ của Cherry chín mọng, kết hợp với nền trà oolong hảo hạng và lớp foam sánh mịn, để mang đến cho bạn một thức uống khoan khoái và dậy lên từng phong vị chua, béo, ngọt đầy ấn tượng.',3,55000, 'appdata/products/PRO00011.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00012', 'TRÀ SỮA MẮC CA TRÂN CHÂU TRẮNG', 'Mỗi ngày với Nhà sẽ là điều tươi mới hơn với sữa hạt mắc ca thơm ngon, bổ dưỡng quyện cùng nền trà Oolong cho vị cân bằng, ngọt dịu. Trân châu trắng giòn dai được thêm sẵn, mang lại cho bạn cảm giác "đã" trong từng ngụm, thoả cơn thèm trà sữa ngay.',3,45000, 'appdata/products/PRO00012.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00013', 'CHOCOLATE ĐÁ XAY', 'Vị đắng của cà phê kết hợp cùng vị cacao ngọt ngàocủa sô-cô-la, vị sữa tươi ngọt béo, đem đến trải nghiệm vị giác cực kỳ thú vị.',4,59000, 'appdata/products/PRO00013.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00014', 'COOKIES ĐÁ XAY', 'Những mẩu bánh cookies giòn rụm kết hợp ăn ý với sữa tươi và kem tươi béo ngọt, đem đến cảm giác lạ miệng gây thích thú. Một món uống phá cách dễ thương.',4,59000, 'appdata/products/PRO00014.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00015', 'PHÚC BỒN TỬ CAM ĐÁ XAY', 'Tê tái ngay đầu lưỡi bởi sự mát lạnh của đá xay. Hòa quyện thêm hương vị chua chua, ngọt ngọt từ trái cam tươi và trái phúc bồn tử 100% tự nhiên, để cho ra một hương vị thanh mát, kích thích vị giác đầy thú vị ngay từ lần đầu thưởng thức.',4,59000, 'appdata/products/PRO00015.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00016', 'MATCHA ĐÁ XAY', 'Matcha thanh, nhẫn, và đắng nhẹ được nhân đôi sảng khoái khi uống lạnh. Nhấn nhá thêm những nét bùi béo của kem và sữa. Gây thương nhớ vô cùng!',4,59000, 'appdata/products/PRO00016.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00017', 'BÁNH BÔNG LAN TRỨNG MUỐI', 'Chắc chắn bạn sẽ không thể cưỡng lại chiếc bánh bông lan tơi xốp, mềm mịn, vị ngọt dịu kết hợp với trứng muối và chà bông đậm đà, cân bằng vị giác.',5,29000, 'appdata/products/PRO00017.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00018', 'BÁNH CHOCOLATE', 'Từng lớp bánh mịn ngọt ngào đậm vị chiều lòng người yêu thích hương vị sô cô la. Sẽ ngon hơn nếu bạn kết hợp cùng món trà trái cây thanh mát.',5,29000, 'appdata/products/PRO00018.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00019', 'BÁNH CROISSANT BƠ TỎI', 'Thưởng thức ngay chiếc bánh Croissant bơ tỏi thơm lừng, bên ngoài vỏ bánh giòn hấp dẫn bên trong mềm dai vị ngon khó cưỡng.',5,29000, 'appdata/products/PRO00019.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00020', 'BÁNH MÌ CHÀ BÔNG PHÔ MAI', 'Bạn không thể bỏ lỡ chiếc bánh với lớp phô mai vàng sánh mịn bên trong, được bọc ngoài lớp vỏ xốp mềm thơm lừng. Thêm lớp chà bông mằn mặn hấp dẫn bên trên.',5,32000, 'appdata/products/PRO00020.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00021', 'BÁNH MATCHA', 'Khám phá từng tầng vị trà xanh thơm lừng xen kẽ lớp kéo béo dịu với đậu đỏ.',5,29000, 'appdata/products/PRO00021.png');
INSERT INTO `product` (`Code`, `ProductTitle`, `Description`, `CategoryID`, `Price`, `ImageURL`) VALUES ('PRO00022', 'BÁNH GẤU CHOCOLATE', 'Với vẻ ngoài đáng yêu và hương vị ngọt ngào, thơm béo nhất định bạn phải thử ít nhất 1 lần.',5,39000, 'appdata/products/PRO00022.png');
